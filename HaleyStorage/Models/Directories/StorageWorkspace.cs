...
namespace Haley.Models {
    ...
    /// Workspaces define how file identifiers are generated (<see cref="StorageNameMode"/>)
    /// and whether names are auto-generated or parsed from caller input (<see cref="StorageNameParseMode"/>).
    ...
    public class StorageWorkspace : VaultComponent, IVaultWorkSpace {
        ...
        public void Assert() {
            ...
            if (!IsVirtual &&  (string.IsNullOrEmpty(StorageName)  || string.IsNullOrEmpty(StorageRef))) throw new ArgumentNullException("StorageRef Cannot be empty");
