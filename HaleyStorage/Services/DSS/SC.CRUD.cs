    ...
    public partial class StorageCoordinator : IStorageCoordinator {
        public async Task<IVaultResponse> Upload(IVaultWriteRequest input) {
            ...
            try {
                ...
                if (!result.PhysicalObjectExists || input.ResolveMode == ExistConflictResolveMode.Replace) {
                ...
                } else if (input.ResolveMode == ExistConflictResolveMode.Revise) {
        ...
        public Task<IVaultStreamResponse> Download(IVaultFileReadRequest input, bool auto_search_extension = true) {
            IVaultStreamResponse result = new VaultStreamResponse() { Status = false, Stream = Stream.Null };
        ...
        public Task<IVaultStreamResponse> Download(IVaultFileRoute input, bool auto_search_extension = true) {
        ...
        public Task<IVaultDirResponse> GetDirectoryInfo(IVaultReadRequest input) {
            IVaultDirResponse result = new VaultDirResponse() { Status = false };
        ...
        public async Task<IVaultResponse> CreateDirectory(IVaultReadRequest input, string rawname) {
            IVaultResponse result = new VaultResponse() {
                Status = false,
                RawName = rawname
            };
            try {
        ...
        bool ShouldProceedFileUpload(IVaultResponse result, string filePath, ExistConflictResolveMode conflict) {
