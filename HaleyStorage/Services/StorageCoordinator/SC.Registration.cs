...
namespace Haley.Services {
    ...
    public partial class StorageCoordinator : IStorageCoordinator {
        ...
        public async Task<IFeedback> RegisterWorkSpace(IVaultStorable wspace, IVaultStorable client, IVaultStorable module, VaultControlMode content_control = VaultControlMode.Number, VaultParseMode content_pmode = VaultParseMode.Generate) {
            string msg = string.Empty;
