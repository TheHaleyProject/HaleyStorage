...
namespace Haley.Abstractions {
    public interface IVaultManagement {
        ...
        Task<IFeedback> RegisterWorkSpace(string workspace_name = null, string client_name = null, string module_name = null, StorageNameMode content_control = StorageNameMode.Number, StorageNameParseMode content_pmode = StorageNameParseMode.Generate, bool is_virtual = false); //If a client is not registered, we register it against "Default"
        ...
        Task<IFeedback> RegisterWorkSpace(IVaultStorable wspace, IVaultStorable client, IVaultStorable module, StorageNameMode content_control = StorageNameMode.Number, StorageNameParseMode content_pmode = StorageNameParseMode.Generate);
